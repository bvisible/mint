...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        ////// Neoffice — z-50 raised to z-[1050] (e582a55). /mint renders INSIDE the native Frappe desk
        ////// chrome, whose navbar and sidebar stack above shadcn's default z-50, so every Radix
        ////// overlay opened behind them. Drop the day /mint stops being embedded.
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ////// Neoffice — same z-50 to z-[1050] bump (e582a55), see the overlay above.
