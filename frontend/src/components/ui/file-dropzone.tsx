...
type Props = {
    files: File[],
    ////// Neoffice — NOTHING in this file is our intent. It is upstream v1.5.0 (single-file mode,
    ////// onDrop/onUpdate callbacks, the file-type icon set and its colours), hand-carried by
    ////// 89e7929 because we had not merged upstream's branch. The file is byte-identical to
    ////// upstream/develop today: at the next merge take upstream's file-dropzone.tsx and drop
    ////// every marker in it.
